...
Public Class frmCourse
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            con = New OleDbConnection(cs)
            con.Open()
            Dim ct As String = "select Coursename from course where Coursename='" & txtCourseName.Text & "'"
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = "insert into Course(Coursename) VALUES ('" & txtCourseName.Text & "')"
    ...
    Public Sub DeleteRecord()
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cq As String = "delete from Course where CourseName='" & txtCourseName.Text & "'"
    ...
    Private Sub btnUpdate_record_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate_record.Click
        ...
        Try
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = "update Course set Coursename='" & txtCourseName.Text & "' where Coursename='" & TextBox1.Text & "'"
            cmd = New OleDbCommand(cb)
            cmd.Connection = con
            cmd.ExecuteReader()
