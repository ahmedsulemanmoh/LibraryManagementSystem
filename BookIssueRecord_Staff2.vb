...
Public Class frmBookIssueRecord_Staff2
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            frmBookReturn.Show()
            frmBookReturn.txtTransactionID1.Text = dr.Cells(0).Value.ToString()
            frmBookReturn.dtpIssueDate1.Text = dr.Cells(1).Value.ToString()
            frmBookReturn.dtpDueDate1.Text = dr.Cells(2).Value.ToString()
            frmBookReturn.txtAccessionNo1.Text = dr.Cells(3).Value.ToString()
            frmBookReturn.txtBookTitle1.Text = dr.Cells(4).Value.ToString()
            frmBookReturn.txtAuthor1.Text = dr.Cells(5).Value.ToString()
            frmBookReturn.txtCategory1.Text = dr.Cells(6).Value.ToString()
            frmBookReturn.txtISBN1.Text = dr.Cells(7).Value.ToString()
            frmBookReturn.txtEdition1.Text = dr.Cells(8).Value.ToString()
            frmBookReturn.txtStaffID.Text = dr.Cells(9).Value.ToString()
            frmBookReturn.txtStaffName.Text = dr.Cells(10).Value.ToString()
            frmBookReturn.txtDepartment1.Text = dr.Cells(12).Value.ToString()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
