...
Public Class frmBookIssueRecord2
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            frmBookReturn.Show()
            frmBookReturn.txtTransactionID.Text = dr.Cells(0).Value.ToString()
            frmBookReturn.dtpIssueDate.Text = dr.Cells(1).Value.ToString()
            frmBookReturn.dtpDueDate.Text = dr.Cells(2).Value.ToString()
            frmBookReturn.txtAccessionNo.Text = dr.Cells(3).Value.ToString()
            frmBookReturn.TextBox1.Text = dr.Cells(3).Value.ToString()
            frmBookReturn.txtBookTitle.Text = dr.Cells(4).Value.ToString()
            frmBookReturn.txtAuthor.Text = dr.Cells(5).Value.ToString()
            frmBookReturn.txtCategory.Text = dr.Cells(6).Value.ToString()
            frmBookReturn.txtISBN.Text = dr.Cells(7).Value.ToString()
            frmBookReturn.txtEdition.Text = dr.Cells(8).Value.ToString()
            frmBookReturn.txtStudentID.Text = dr.Cells(9).Value.ToString()
            frmBookReturn.txtStudentName.Text = dr.Cells(10).Value.ToString()
            frmBookReturn.txtCourse.Text = dr.Cells(11).Value.ToString()
            frmBookReturn.txtDepartment.Text = dr.Cells(12).Value.ToString()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
