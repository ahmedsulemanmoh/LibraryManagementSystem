        ...
        Try
            ...
            For i As Integer = listView1.Items.Count - 1 To 0 Step -1
                ...
                Else
                    txtStatus.Text = "No"
                End If
                Dim cd As String = "update Cards_Student set Status='" & txtStatus.Text & "' where StudentID= '" & listView1.Items(i).SubItems(0).Text & "'"
        ...
        Try
            ...
            For i As Integer = ListView2.Items.Count - 1 To 0 Step -1
                ...
                Else
                    txtStatus1.Text = "No"
                End If
                Dim cd As String = "update Cards_Staff set Status='" & txtStatus1.Text & "' where StaffID= '" & ListView2.Items(i).SubItems(0).Text & "'"
                cmd = New OleDbCommand(cd)
                cmd.Connection = con
                con.Open()
                cmd.ExecuteNonQuery()
