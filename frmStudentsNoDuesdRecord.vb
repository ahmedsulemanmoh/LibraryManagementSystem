...
Public Class frmStudentsNoDuesdRecord
    ...
    Sub fillSession()
        ...
        End Try
    End Sub
    Private Sub frmNoDues_Student_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        fillSession()
    End Sub
    ...
    Private Sub cmbCourse_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCourse.SelectedIndexChanged
        Try
            ...
            con.Open()
            Dim ct As String = "select distinct RTRIM(Department) from Student,NoDues_Student where Student.StudentID=NoDues_Student.StudentID and course = '" & cmbCourse.Text & "'"
    ...
    Private Sub cmbSession_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSession.SelectedIndexChanged
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim ct As String = "select distinct RTRIM(Course) from Student,NoDues_Student where Student.StudentID=NoDues_Student.StudentID and Stu_Session= '" & cmbSession.Text & "'"
            cmd = New OleDbCommand(ct)
            cmd.Connection = con
            rdr = cmd.ExecuteReader()
            While rdr.Read()
