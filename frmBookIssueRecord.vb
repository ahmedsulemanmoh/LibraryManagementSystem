...
Public Class frmBookIssueRecord
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            frmBookIssue.Show()
            frmBookIssue.txtTransactionID.Text = dr.Cells(0).Value.ToString()
            frmBookIssue.dtpIssueDate.Text = dr.Cells(1).Value.ToString()
            frmBookIssue.dtpDueDate.Text = dr.Cells(2).Value.ToString()
            frmBookIssue.cmbAccessionNo.Text = dr.Cells(3).Value.ToString()
            frmBookIssue.TextBox1.Text = dr.Cells(3).Value.ToString()
            frmBookIssue.txtBookTitle.Text = dr.Cells(4).Value.ToString()
            frmBookIssue.txtAuthor.Text = dr.Cells(5).Value.ToString()
            frmBookIssue.txtCategory.Text = dr.Cells(6).Value.ToString()
            frmBookIssue.txtISBN.Text = dr.Cells(7).Value.ToString()
            frmBookIssue.txtEdition.Text = dr.Cells(8).Value.ToString()
            frmBookIssue.cmbStudentID.Text = dr.Cells(9).Value.ToString()
            frmBookIssue.txtStudentName.Text = dr.Cells(10).Value.ToString()
            frmBookIssue.txtCourse.Text = dr.Cells(11).Value.ToString()
            frmBookIssue.txtDepartment.Text = dr.Cells(12).Value.ToString()
            frmBookIssue.txtStatus.Text = dr.Cells(13).Value.ToString()
